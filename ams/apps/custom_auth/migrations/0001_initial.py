# Generated by Django 4.2.16 on 2025-02-17 12:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createddate', models.DateTimeField(blank=True, default=django.utils.timezone.now)),
                ('updateddate', models.DateTimeField(null=True)),
                ('owner_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='siteowner', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Site',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attendance', models.CharField(blank=True, choices=[('P', 'Present'), ('A', 'Absent'), ('HD', 'Half_day'), ('OT', 'Over_time')], max_length=2, null=True)),
                ('date', models.DateField(null=True)),
                ('isdeleted', models.BooleanField(default=False)),
                ('createddate', models.DateTimeField(blank=True, default=django.utils.timezone.now)),
                ('updateddate', models.DateTimeField(null=True)),
                ('employee', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='employeeattendance', to='custom_auth.employee')),
